...
podTemplate(label: label, 
    ...
    node(label) {
        ...
        stage('Run Downstream Pipeline'){
            ...
            build: 'dokuti-pipeline/887-link-upstream-and-downstream-repos', parameters: [[$class: 'StringParameterValue', name: 'DOKUTI_BRANCH', value: ${gitBranch}], [$class: 'StringParameterValue', name: 'ParamB', value: paramBValue]]
        }
 }
}